            ...
            <div class="order-details">
                ...
                @foreach($order->orderItems as $orderItem)
                    <div class="order-item">
                        <div>
                            <strong>{{ $orderItem->menuItem->name ?? 'Custom Item' }}</strong>
                            <br>
                            <small>PHP {{ number_format($orderItem->unit_price, 2) }} x {{ $orderItem->quantity }}</small>
                        ...
                        <div>
                            <strong>PHP {{ number_format($orderItem->total_price, 2) }}</strong>
                        </div>
                    </div>
                @endforeach
            </div>
