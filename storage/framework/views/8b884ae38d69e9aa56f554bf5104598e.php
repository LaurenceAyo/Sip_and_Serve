            ...
            <div class="controls-section flex justify-between items-center mb-6">
                <div class="filter-section flex items-center space-x-4">
                    <select class="filter-dropdown">
                        <option <?php echo e(($filter ?? 'TODAY') == 'TODAY' ? 'selected' : ''); ?>>TODAY</option>
                        <option <?php echo e(($filter ?? 'TODAY') == 'THIS WEEK' ? 'selected' : ''); ?>>THIS WEEK</option>
                        <option <?php echo e(($filter ?? 'TODAY') == 'THIS MONTH' ? 'selected' : ''); ?>>THIS MONTH</option>
                    </select>
                </div>
            ...
            printWindow.document.write(`
                ...
                <body>
                    ...
                    <div style="text-align: center; margin-top: 2rem; color: #6b7280; font-size: 0.9rem;">
                        ...
                        <p>Manager ID: <?php echo e(Auth::user()->manager_id ?? 'N/A'); ?></p>
                    </div>
                </body>
                </html>
            `);
