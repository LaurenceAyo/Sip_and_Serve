                ...
                <?php if(isset($pendingOrders) && count($pendingOrders) > 0): ?>
                    <?php $__currentLoopData = $pendingOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="order-card" id="order-<?php echo e($order['id']); ?>" data-order-id="<?php echo e($order['id']); ?>">
                            ...
                            <?php if(isset($order['discount_type']) && $order['discount_type'] !== 'none' && isset($order['discount_amount']) && $order['discount_amount'] > 0): ?>
                                <div class="discount-badge"
                                    ...
                                    🎫 <?php echo e($order['discount_type'] === 'senior_citizen' ? 'Senior Citizen' : 'PWD'); ?> Discount
                                    Applied (20%)
                                    <div style="font-size: 0.85rem; opacity: 0.95; margin-top: 4px;">
                                        ID: <?php echo e($order['discount_id_number'] ?? 'N/A'); ?> • Saved: PHP
                                        <?php echo e(number_format($order['discount_amount'], 2)); ?>

                                    </div>
                                    <button onclick="removeDiscount(<?php echo e($order['id']); ?>)"
                            ...
                            <div class="order-actions">
                                ...
                                <?php if(!isset($order['discount_type']) || $order['discount_type'] === 'none' || !isset($order['discount_amount']) || $order['discount_amount'] <= 0): ?>
                                    <button class="btn btn-discount"
                                        onclick="openDiscountModal(<?php echo e($order['id']); ?>, <?php echo e($order['total'] ?? $order['total_amount'] ?? 0); ?>)"
