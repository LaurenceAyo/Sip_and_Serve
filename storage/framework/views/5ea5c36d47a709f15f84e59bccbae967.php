...
<body>
    ...
    <div class="background-slideshow">
        <div class="background-slide active"
            style="background-image: url('<?php echo e(asset('assets/background_main_2.jpg')); ?>');"></div>
        <div class="background-slide" style="background-image: url('<?php echo e(asset('assets/background_main_3.jpg')); ?>');">
        </div>
        <div class="background-slide" style="background-image: url('<?php echo e(asset('assets/background_main_4.jpg')); ?>');">
        </div>
    </div>
    ...
    <div class="cover-container">
        ...
        <div class="button-container">
            <!-- Staff/Admin Login -->
            <a href="<?php echo e(route('login')); ?>?from=staff" class="mode-button">
            ...
            <!-- Kiosk Mode -->
            <a href="<?php echo e(route('kiosk.index')); ?>" class="mode-button">
                <span class="button-icon">🛒</span>
...
</html><?php /**PATH C:\Users\Laurence Ayo\sip_and_serve_final\resources\views/cover.blade.php ENDPATH**/ ?>