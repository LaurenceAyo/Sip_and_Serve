...
<body>
    <div class="dashboard-container">
                    ...
                    <table class="inventory-table" style="width: 100%;">
                        <tbody id="inventoryBody">
                            <?php $__currentLoopData = $inventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr data-category="<?php echo e($item->ingredient->category ?? 'ingredients'); ?>"
                                    style="display: flex;">
                                    <td style="flex: 1; padding: 12px; text-align: center;">
                                        <?php echo e($item->ingredient->name ?? 'Item ' . $item->menu_item_id); ?>

                                    </td>

                                    <td style="flex: 1; padding: 12px; text-align: center;">
                                        <?php echo e(number_format($item->maximum_stock, 2)); ?>

                                    </td>

                                    <td style="flex: 1; padding: 12px; text-align: center;">
                                        <?php echo e(number_format($item->used_stock ?? 0, 2)); ?>

                                    </td>

                                    <td style="flex: 1; padding: 12px; text-align: center;">
                                        <?php echo e(number_format($item->current_stock, 2)); ?> <?php echo e($item->unit); ?>

                                    </td>

                                    <td style="flex: 1; padding: 12px; text-align: center;">
                                        <div class="status-indicator status-<?php echo e($item->status); ?>"
                                            title="Current: <?php echo e(number_format($item->current_stock, 2)); ?> | Min: <?php echo e(number_format($item->minimum_stock, 2)); ?> | Max: <?php echo e(number_format($item->maximum_stock, 2)); ?>">
                                        </div>
                                    </td>
                                </tr>
        ...
        <?php if(auth()->user()->email === 'laurenceayo7@gmail.com'): ?>
            <div class="row mb-4">
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <a href="<?php echo e(route('admin.users')); ?>" class="user-management-card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="card-stats">
                                                <div class="stat-item">
                                                    <span class="stat-number"><?php echo e(\App\Models\User::count() ?? '0'); ?></span>
        ...
        <script>
            ...
            let ingredientsData = [
                <?php $__currentLoopData = $inventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    menu_item_id: <?php echo e($item->menu_item_id); ?>,
                    name: <?php echo json_encode($item->ingredient->name ?? 'Unknown'); ?>,
                    unit: <?php echo json_encode($item->unit ?? 'units'); ?>,
                    current_stock: <?php echo e($item->current_stock ?? 0); ?>,
                    minimum_stock: <?php echo e($item->minimum_stock ?? 0); ?>,
                    maximum_stock: <?php echo e($item->maximum_stock ?? 0); ?>
...
</html><?php /**PATH C:\Users\Laurence Ayo\sip_and_serve_final\resources\views/dashboard.blade.php ENDPATH**/ ?>