        ...
        <main class="main-content" id="mainContent">
            <div class="content-wrapper">
                ...
                <div class="action-buttons">
                    <form method="POST" action="<?php echo e(route('kiosk.dineIn')); ?>" class="button-form" id="dineInForm">
                        <?php echo csrf_field(); ?>
                    ...
                    <form method="POST" action="<?php echo e(route('kiosk.takeOut')); ?>" class="button-form" id="takeOutForm">
                        <?php echo csrf_field(); ?>
